...
const defaultPrivacyValues: PrivacyFormValues = {
  ...
  intro: "দারুল ইসলাম ইনস্টিটিউট মাদ্রাসায় আপনার ব্যক্তিগত তথ্যের নিরাপত্তা আমাদের কাছে অত্যন্ত গুরুত্বপূর্ণ। আমাদের ওয়েবসাইট ব্যবহারের সময় আমরা কীভাবে আপনার তথ্য সংগ্রহ ও ব্যবহার করি, তা নিচে বিস্তারিত জানানো হলো:",
...
export default function PrivacyAdminForm() {
  const { register, control, handleSubmit, formState: { errors } } = useForm<PrivacyFormValues>({
  ...
  const onSubmit = (data: PrivacyFormValues) => {
    console.log("আপনার জেনারেট হওয়া নতুন Privacy Policy JSON ডাটা:", JSON.stringify(data, null, 2));
    alert("ডাটা সফলভাবে সাবমিট হয়েছে! ব্রাউজারের কনসোল (Console) চেক করুন।");
  };

  return (
    <div className="bg-gray-50 min-h-screen pt-18 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-10">
        
        {/* ফর্ম হেডার */}
        <div className="flex items-center justify-between border-b pb-4 mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">গোপনীয়তা নীতি আপডেট ফর্ম</h1>
            <p className="text-sm text-gray-500 mt-1">দারুল ইসলাম ইনস্টিটিউট — অ্যাডমিন প্যানেল</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-50 p-4 rounded-xl border border-gray-100">
            <div>
              <label className="block text-xs font-bold text-gray-600 mb-1 uppercase tracking-wider">পেজ টাইটেল</label>
              <input 
            ...
            <div>
              <label className="block text-xs font-bold text-gray-600 mb-1 uppercase tracking-wider">প্রতিষ্ঠানের নাম</label>
              <input 
            ...
            <div className="md:col-span-2">
              <label className="block text-xs font-bold text-gray-600 mb-1 uppercase tracking-wider">ভূমিকা (Introductory Text)</label>
              <textarea 
            ...
            <div className="md:col-span-2">
              <label className="block text-xs font-bold text-gray-600 mb-1 uppercase tracking-wider">সর্বশেষ পরিমার্জিত (Last Updated)</label>
              <input 
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <h2 className="text-lg font-bold text-gray-800">নীতিমালার পয়েন্টসমূহ</h2>
              <button
                type="button"
                onClick={() => append({ id: Date.now(), iconName: "ShieldCheck", heading: "", text: "" })}
            ...
            {fields.map((field, index) => (
              <div key={field.id} className="border border-gray-200 rounded-xl p-4 md:p-6 space-y-4 bg-white relative shadow-sm hover:border-gray-300 transition-colors">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {/* পয়েন্ট হেডিং */}
                  <div className="md:col-span-2">
                    <label className="block text-xs font-bold text-gray-600 mb-1">পয়েন্টের শিরোনাম (Heading)</label>
                    <input 
                      {...register(`sections.${index}.heading` as const, { required: "শিরোনাম প্রয়োজন" })}
                  ...
                  {/* আইকন সিলেক্টর */}
                  <div>
                    <label className="block text-xs font-bold text-gray-600 mb-1">আইকন (Lucide Icon)</label>
                    <select 
                    ...
                    >
                      ...
                      <option value="ShieldCheck">ShieldCheck (তথ্য ব্যবহার)</option>
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-600 mb-1">বিস্তারিত বিবরণ (Description)</label>
                  <textarea 
                    {...register(`sections.${index}.text` as const, { required: "বিবরণ প্রয়োজন" })}
                    rows={3}
